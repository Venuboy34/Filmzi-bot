...
async def is_subscribed(bot, query, fsub_channels):
    ...
    for channel_id in fsub_channels:
        try:
            ...
            btn.append([InlineKeyboardButton(f' {chat.title}', url=chat.invite_link)])
        except Exception as e:
    ...
    try:
        if settings["imdb"]:
            ...
            if IMDB_CAP:
                ...
                if imdb:
                    ...
                    cap = (
                        ...
                        f"Rᴇǫᴜᴇsᴛᴇᴅ Bʏ ☞ {query.from_user.mention}\n\n"
                        f"ʀᴇsᴜʟᴛ sʜᴏᴡ ɪɴ ☞ {remaining_seconds} sᴇᴄᴏɴᴅs\n\m"
                        f"ᴘᴏᴡᴇʀᴇᴅ ʙʏ ☞ : {query.message.chat.title}\n\n"
                        f"⚠️ ᴀꜰᴛᴇʀ 5 ᴍɪɴᴜᴛᴇꜱ ᴛʜɪꜱ ᴍᴇꜱꜱᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ 🗑️\n\n</b>"
                            )
                    cap+="<b>🍿 Yᴏᴜʀ Mᴏᴠɪᴇ Fɪʟᴇꜱ 👇</b>\n\n"
                    for file in files:
                        cap += (
                            f"<b><a href='https://telegram.me/{temp.U_NAME}?start=file_{query.message.chat.id}_{file.file_id}'>"
                            f"📁 {get_size(file.file_size)} ≽ "
            ...
            cap = (
                ...
                f"Rᴇǫᴜᴇsᴛᴇᴅ Bʏ ☞ {query.from_user.mention}\n\n"
                f"ʀᴇsᴜʟᴛ sʜᴏᴡ ɪɴ ☞ {remaining_seconds} sᴇᴄᴏɴᴅs\n\n"
                f"ᴘᴏᴡᴇʀᴇᴅ ʙʏ ☞ : {query.message.chat.title or temp.B_LINK or 'HD Pʀᴏ Sᴇᴀʀᴄʜ Bᴏᴛ 🔍'}\n\n"
                f"⚠️ ᴀꜰᴛᴇʀ 5 ᴍɪɴᴜᴛᴇꜱ ᴛʜɪꜱ ᴍᴇꜱꜱᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ 🗑️\n\n</b>"
                    )
            cap+="<b>🍿 Yᴏᴜʀ Mᴏᴠɪᴇ Fɪʟᴇꜱ 👇</b>\n\n"
            for file in files:
