...
async def give_filter(client, message):
    ...
    if message.chat.id != SUPPORT_CHAT_ID:
        ...
        await message.reply_text(
            ...
            f"<b>📌 Yᴏᴜʀ Rᴇǫᴜᴇꜱᴛ Iꜱ Aʟʀᴇᴀᴅʏ Aᴠᴀɪʟᴀʙʟᴇ 🎯</b>\n\n"
            f"<b>📁 Fɪʟᴇꜱ Fᴏᴜɴᴅ :</b> <code>{str(total_results)}</code>\n"
            f"<b>🔎 Sᴇᴀʀᴄʜ :</b> <code>{search}</code>\n\n"
            f"<b>⚠️ Tʜɪꜱ Iꜱ A <u>Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ</u>, Sᴏ Yᴏᴜ Cᴀɴ’ᴛ Gᴇᴛ Fɪʟᴇꜱ Fʀᴏᴍ Hᴇʀᴇ.</b>\n\n"
            f"<b>📥 Jᴏɪɴ & Sᴇᴀʀᴄʜ Hᴇʀᴇ 👇</b>",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("➕ Jᴏɪɴ Aɴᴅ ꜱᴇᴀʀᴄʜ Hᴇʀᴇ ➕", url=GRP_LNK)]])
        )
    ...
    try:
        ...
        if pm_search:
            ...
            await message.reply_text(
                text=(
                    f"<b>👋 Hᴇʏ {user}!</b>\n\n"
                    "Yᴏᴜ ᴄᴀɴ sᴇᴀʀᴄʜ ꜰᴏʀ ᴍᴏᴠɪᴇs ᴏɴʟʏ ᴏɴ ᴏᴜʀ Mᴏᴠɪᴇ Gʀᴏᴜᴘ.\n"
                    "Yᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴀʟʟᴏᴡᴇᴅ ᴛᴏ sᴇᴀʀᴄʜ ꜰᴏʀ ᴍᴏᴠɪᴇs ᴏɴ Dɪʀᴇᴄᴛ Bᴏᴛ.\n"
                    "Pʟᴇᴀsᴇ ᴊᴏɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴏɴ ᴛʜᴇ <b>Rᴇǫᴜᴇsᴛ Hᴇʀᴇ</b> ʙᴜᴛᴛᴏɴ 👇\n\n"
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('ʜᴅᴘꜱʙᴏᴛ 🔍', url='https://github.com/Rpedit/HD-Pro-Search-Bot.git'),
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='about')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
...
async def auto_filter(client, msg, spoll=False):
        ...
        if len(message.text) < 100:
            ...
            if not files:
                if settings["spell_check"]:
                    ai_sts = await m.edit('🔎 ᴄʜᴇᴄᴋɪɴɢ ʏᴏᴜʀ ꜱᴘᴇʟʟɪɴɢ, ᴘʟᴇᴀꜱᴇ ᴡᴀɪᴛ...')
    ...
    if imdb:
        ...
        if settings.get('button'):
            cap = f"<b>Tʜᴇ Rᴇꜱᴜʟᴛꜱ Fᴏʀ ☞ {search}\n\nRᴇǫᴜᴇsᴛᴇᴅ Bʏ ☞ {message.from_user.mention}\n\nʀᴇsᴜʟᴛ sʜᴏᴡ ɪɴ ☞ {remaining_seconds} sᴇᴄᴏɴᴅs\n\nᴘᴏᴡᴇʀᴇᴅ ʙʏ ☞ : {message.chat.title or temp.B_LINK or 'HD Pʀᴏ Sᴇᴀʀᴄʜ Bᴏᴛ 🔍'} \n\n⚠️ ᴀꜰᴛᴇʀ 5 ᴍɪɴᴜᴛᴇꜱ ᴛʜɪꜱ ᴍᴇꜱꜱᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ 🗑️\n\n🍿 Yᴏᴜʀ Mᴏᴠɪᴇ Fɪʟᴇꜱ 👇\n\n</b>"
        else:
            cap = f"<b>Tʜᴇ Rᴇꜱᴜʟᴛꜱ Fᴏʀ ☞ {search}\n\nRᴇǫᴜᴇsᴛᴇᴅ Bʏ ☞ {message.from_user.mention}\n\nʀᴇsᴜʟᴛ sʜᴏᴡ ɪɴ ☞ {remaining_seconds} sᴇᴄᴏɴᴅs\n\nᴘᴏᴡᴇʀᴇᴅ ʙʏ ☞ : {message.chat.title or temp.B_LINK or 'HD Pʀᴏ Sᴇᴀʀᴄʜ Bᴏᴛ 🔍'} \n\n⚠️ ᴀꜰᴛᴇʀ 5 ᴍɪɴᴜᴛᴇꜱ ᴛʜɪꜱ ᴍᴇꜱꜱᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ 🗑️\n\n🍿 Yᴏᴜʀ Mᴏᴠɪᴇ Fɪʟᴇꜱ 👇\n\n</b>"
